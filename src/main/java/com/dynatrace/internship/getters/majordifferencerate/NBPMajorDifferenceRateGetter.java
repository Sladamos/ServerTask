...
public abstract class NBPMajorDifferenceRateGetter implements MajorDifferenceRateGetter{
    ...
    @Override
    public RateDifference getMajorDifference(Currency currency, int numberOfQuotations) {
        ...
        try {
            ...
            tryToConnect(conn);
            return getMajorDifferenceFromUrl(conn.getURL());
    ...
    protected abstract RateDifference getMajorDifferenceFromUrl(URL url);
